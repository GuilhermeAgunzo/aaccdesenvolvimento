...
echo "<div class='col-sm-2'>";
echo form_input(array("name" => "unidade", "type" => "number", "value" => set_value("unidade",""), "id" => "unidade" ,"class" => "form-control", "maxlength" => "4", "required" => "required"));
...
echo "<div class='col-sm-2'>";
echo form_input(array("name" => "ano", "type" => "number", "value" => set_value("ano",""), "id" => "ano" ,"class" => "form-control", "maxlength" => "4", "minlength" => "4", "required" => "required", "min" => "1969"));
echo form_error("ano");
echo "</div>";
echo "</div>";
...
echo form_dropdown('semestre',$semestre, "", array("class" => "form-control"));

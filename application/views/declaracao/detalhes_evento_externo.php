...
echo form_input(array("name" => "data", "id" => "data" ,"class" => "form-control", "Disabled" => "Disabled"));
echo "</div>";
echo "</div>";
...
echo form_input(array("name" => "local", "id" => "local" ,"class" => "form-control","Disabled" => "Disabled"));
echo "</div>";
echo "</div>";
...
echo "<div class='col-sm-8'>";
echo form_input(array("name" => "nome", "id" => "nome" ,"class" => "form-control", "Disabled" => "Disabled"));
echo "</div>";
echo "</div>";
...
echo form_input(array("name" => "qtdHoras", "id" => "qtdHoras" ,"class" => "form-control", "Disabled" => "Disabled"));
echo "</div>";
echo "</div>";
...
echo "<div class='col-sm-8'>";
echo form_textarea(array('name' => 'resumo', 'class' => 'form-control', 'id' => 'resumo', 'row' => 2, "Disabled" => "Disabled" ));
echo "</div>";
echo "</div>";

...
if(isset($unidade) || isset($erro)) {
    ...
    echo form_input(array("name" => "nm_unidade", "value" => set_value("nm_unidade",$unidade['nm_unidade']), "id" => "nm_unidade", "class" => "form-control", "maxlength" => "100"));
    ...
    echo form_label("Código da Unidade", "cd_cpsouza", array("class" => "col-sm-2 control-label"));
    echo "<div class='col-sm-6'>";
    echo form_input(array("name" => "cd_cpsouza", "value" => set_value("cd_cpsouza",$unidade['cd_cpsouza']), "id" => "cd_cpsouza" ,"class" => "form-control", "maxlength" => "80"));
    ...
    echo "<div class='col-sm-8'>";
    echo form_input(array("name" => "endereco", "value" => set_value("endereco",$unidade['nm_endereco']), "id" => "endereco", "class" => "form-control", "maxlength" => "100"));
    echo "</div>";
    echo "</div>";
    ...
    echo "<div class='col-sm-6'>";
    echo form_input(array("name" => "complemento", "value" => set_value("complemento",$unidade['nm_complemento_endereco']), "id" => "complemento", "class" => "form-control", "maxlength" => "40"));
    ...
    echo "<div class='col-sm-6'>";
    echo form_input(array("name" => "bairro", "value" => set_value("bairro",$unidade['nm_bairro']), "id" => "bairro", "class" => "form-control", "maxlength" => "80"));
    ...
    echo "<div class='col-sm-6'>";
    echo form_input(array("name" => "cidade", "value" => set_value("cidade",$unidade['nm_cidade']), "id" => "cidade", "class" => "form-control", "maxlength" => "80"));
    ...
    echo form_dropdown('uf', $opcao, set_value("uf",$unidade['UF_estado']), array("class" => "form-control"));
    echo "</div>";
    echo "</div>";

            ...
            if(isset($professor)){
                ...
                echo "<div class='col-sm-6'>";
                echo form_input(array("name" => "data_entrada", "id" => "data_entrada" ,"class" => "form-control", "maxlength" => "10", "value" => implode("/", array_reverse(explode("-",$professor["dt_entrada"])))));
                echo "</div>";
                echo "</div>";
                ...
                echo "<div class='col-sm-6'>";
                echo form_input(array("name" => "data_saida", "id" => "data_saida" ,"class" => "form-control", "maxlength" => "80", "value" => implode("/", array_reverse(explode("-",$professor["dt_saida"])))));
                echo "</div>";
                echo "</div>";

...
if(isset($declaracaoCompleta)) {
        ...
        echo form_fieldset("<h1>Relatório</h1>");
        ...
        echo form_label("Não Aprovado", "naoAprovado", array("class" => "col-sm-3 control-label"));
        echo "</div>";
        echo "<div class='form-group col-md-2'>";
        echo form_radio('aprovacao', '3', @$nchecked, array( "value" => set_value("aprovacao", "3") ,"name" => 'aprovacao', "type" => 'radio', "class" => "col-sm-5 control-label"));
        echo "</div>";
        echo "<div class='form-group col-md-1'>";
        echo form_label("Aprovado", "aprovado", array("class" => "col-sm-3 control-label"));
        echo "</div>";
        echo "<div class='form-group col-md-2'>";
        echo form_radio('aprovacao', '2', @$nchecked, array("value" => set_value("aprovacao", "2"), "name" => 'aprovacao', "type" => 'radio', "class" => "col-sm-5 control-label"));
        ...
        echo form_dropdown( "motivoIdIndeferimento",$motivoNomeIndeferimento,"", array("class" => "form-control", "value" => set_value("motivoIdIndeferimento", "" )));
        ...
        echo "<div class='row'>";
        echo "<div class='form-group col-md-3'>";
        echo form_label("Total de Horas Aprovadas", "HorasAprovadas", array("class" => "col-sm-4 control-label"));
        echo "</div>";
        echo "<div class='form-group col-md-3'>";
        ...
        echo "</div>";
        echo "<div class='form-group col-md-3'>";
        echo form_label("Data da Aprovação", "dt_aprovacao", array("class" => "col-sm-4 control-label"));
        echo "</div>";
        echo "<div class='form-group col-md-3'>";
